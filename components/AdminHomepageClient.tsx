...
export function AdminHomepageClient({ initialSettings, reviews }: { initialSettings: HomeControlSettings; reviews: AdminReview[] }) {
  ...
  function patchSection(section: keyof Pick<HomeControlSettings, 'directionsSection' | 'productsSection' | 'collectionsSection' | 'productionSection' | 'stepsSection' | 'gallerySection' | 'reviewsSection' | 'cta'>, patch: Record<string, unknown>) {
