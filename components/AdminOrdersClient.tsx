    ...
    <div className="admin-commerce-page">
      <div className="admin-page-head">
        <div>
          ...
          <span>Просмотр заказов, товаров, контактов клиента, суммы и статуса обработки.</span>
        </div>
      ...
      <div className="admin-commerce-toolbar">
        <input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Поиск по номеру, клиенту, телефону или товару" />
        <div>
      ...
      {!orders.length ? (
        <section className="admin-empty-commerce">
          ...
          <p>Когда клиент оформит заказ через корзину, он появится здесь.</p>
