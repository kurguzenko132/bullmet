...
Утверждённый справочник содержит 12 категорий: Авто-мир, Барбершоп,
парикмахерская, Графика, Детские, Животные, Классика, Кофе и кухня, Музыка,
Профессии, Романтика, Рыбалка и охота, Спорт. Категория «Христианские»
исключена. Перед первым импортом WooCommerce нужно утвердить URL strategy и
mapping старых slug.
...
2. Использовать утверждённый справочник из 12 категорий часов и утвердить URL strategy.
