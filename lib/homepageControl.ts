...
export const defaultHomepageControl: HomeControlSettings = {
  hero: {
    ...
    text: 'Bullmet — собственное производство настенных часов и металлических изделий. Стартуем с коллекции часов: выразительный металл, тёплые элементы дерева и аккуратная ручная сборка.',
  ...
  directionsSection: {
    enabled: true,
    eyebrow: 'категории и направления',
    title: 'Bullmet — не просто каталог, а производство',
    text: 'Основной запуск — настенные часы. Остальные направления подготовлены и будут включаться по мере готовности.',
  ...
  productsSection: {
    enabled: true,
    eyebrow: 'коллекция часов',
    title: 'Настенные часы Bullmet',
    text: 'Металлические модели с характером: для дома, кабинета, мастерской, кафе и подарка.',
  ...
  productionSection: {
    enabled: true,
    eyebrow: 'металл, дерево и производство',
    title: 'Свой характер, а не типовой магазин инструмента',
    text: 'В основе визуального стиля Bullmet — графитовый металл, тёплые деревянные детали и собственное производство. Оранжевый остаётся акцентом, но сайт получает более спокойный и самостоятельный образ.',
